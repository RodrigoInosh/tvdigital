var Radio = {
    getPdf: function(form_elements, form_pdf_data) {
        ...
        var title = 'CÁLCULOS CON ' + radials + ' RADIALES FORMULARIO PROYECTO TÉCNICO PARA LA TRANSICIÓN ANÁLOGO-DIGITAL DEL SERVICIO DE RADIODIFUSIÓN'
        ...
        var doc = {
            ...
            pageSize: 'A4',
            content: [
                Radio.getPdfPage(title, form_elements, form_pdf_data),
                Radio.getTableTechnicalSystemFeature('CARACTERÍSTICAS TÉCNICAS DEL SISTEMA RADIANTE PRINCIPAL', radials, form_elements, form_pdf_data)
            ]
        }
    ...
    var obj = [{
        ...
        },
        {
            table: {
                ...
                body: [
                    [{
                        text: 'DATOS GENERALES CONCESIÓN EXISTENTE',
                        colSpan: 4,
                        alignment: 'center',
                        bold: true,
                        decoration: 'underline',
                    ...
                    [{
                            text: 'Frecuencia:    ' + frecuencia_analoga,
                            fontSize: 10,
                            border: [true, false, false, true]
                        }, {
        ...
        },
        {
            table: {
                ...
                body: [
                    [{
                        text: 'DATOS GENERALES CONCESIÓN SOLICITADA',
                        colSpan: 4,
                        alignment: 'center',
                        bold: true,
                        decoration: 'underline',
                    ...
                    [{
                            text: 'Frecuencia:     ' + frecuencia_digital,
                            fontSize: 10,
                            border: [true, false, false, false]
                        }, {
                            text: 'Señal distintiva:    ' + form_elements.pIdentificador,
                    ...
                    [{
                            text: 'Domicilio Calle:    ' + domicilio,
                            colSpan: 2,
                            fontSize: 10,
                            border: [true, false, false, false]
                        }, {},
...
// function getPdfRadioModificacion(form_elements, form_pdf_data) {
...
// function getPage12(title, form_elements) {
//     console.log("12");
//     var nombre_rep_legal = form_pdf_data.tab_general.rep_legal.nombre;
//     var rut_rep_legal = form_pdf_data.tab_general.rep_legal.rut;
//     var num_res_otorga = form_pdf_data.tab_general.res_otorga.num;
