...
function get18RadialsTable(form_elements, cicles, vertical_grades, horizontal_grades) {
    ...
    var radials_table = [{
        ...
        table: {
            ...
            body: createRadialsTable(cicles, vertical_grades, horizontal_grades)
        },
    }, {}, {}, {}
    ];
...
function createRadialsTable(cicles, vertical_grades, horizontal_grades) {
	var aux = [];
    ...
    for(x = 0; x < cicles; x++){
		...
		aux.push(getRadialsTableRowData('Perd. por lóbulo (dB)',  vertical_grades*x, horizontal_grades, 'M18P'));
		aux.push(getRadialsTableRowData('Distancia Zona Servicio (km)', vertical_grades*x, horizontal_grades, 'DIS'));
	}
...
function getRadialsTableRowData(title, init_grade, added_grades, parameter) {
