...
<div id="divtabE" class="tabcontent">
    <ul>
        <li>
            <label><b><u>Caracter&iacute;sticas Sistema Radiante</u></b></label>
        </li>
        <div id="separador" style="height: 1px;"></div>
        <li style="width: 68px; text-align: left">Sist Radiante:</li>
        <li>
            <select id="sistRadiante">
                <option value="sistRadiantePrinc">Principal</option>
                <option value="sistRadianteAdic1">Adicional 1</option>
                <option value="sistRadianteAdic2">Adicional 2</option>
            </select>
        </li>
        ...
        <li style="width: 76px; text-align: left">Tipo de Antena:</li>
        <li>
        ...
        <li style="width: 121px; text-align: left">N&deg Elementos de Antena:</li>
        <li>
            <input type="text" id="numElem" class="number_input" style="width: 95px;" />
        </li>
        <div id="separador"></div>
